                ...
                if(Pattern.matches("^[0-3]*$", userInput)) {
                    switch (Integer.parseInt(userInput)) {
                        case 1:
                            ...
                            if (user1.getWallet().getBalance() >= 13) {
                                currentCheck += 13;
                        ...
                        case 2:
                            ...
                            if (user1.getWallet().getBalance() >= 22) {
                                currentCheck += 22;
                                System.out.println("Hmmmm that was delicious!");
                            } else
                                System.out.println("You cannot afford this dish.");
                        ...
                        case 3:
                            ...
                            if (user1.getWallet().getBalance() >= 16) {
                                currentCheck += 16;
                                System.out.println("Hmmmm that was delicious!");
                            } else
                                System.out.println("You cannot afford this dish.");
                            break;
                        case 0:
                            System.out.println("Here's your bill: " + currentCheck + "€");
                            user1.getWallet().setBalance(-currentCheck);
                            doneEating = true;
                            break;
                        default:
